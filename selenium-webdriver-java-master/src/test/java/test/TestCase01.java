...
//        WebElement searchElem = wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.id("search"))));
//        WebElement searchBtnElem = driver.findElement(By.cssSelector("button[title='Search']"));
//        searchElem.sendKeys("galaxy");
//        Thread.sleep(2000);
//        searchBtnElem.click();
//        Thread.sleep(2000);
